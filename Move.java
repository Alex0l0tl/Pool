public class Move
    ...
    double xPosition1, xPosition2, yPosition1, yPosition2;//Import values from initialization         
    double xSpeed1, xSpeed2, ySpeed1, ySpeed2;//Calulate from force and angle of pool stick
